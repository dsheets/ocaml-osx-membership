...
dispatch begin
  ...
  | After_rules ->
    ...
    dep ["ocaml"; "link"; "byte"; "library"; "use_osx_membership_stubs"]
      ["lib/dllosx_membership_stubs"-.-(!Options.ext_dll)];
    flag ["ocaml"; "link"; "byte"; "library"; "use_osx_membership_stubs"] &
    S[A"-dllib"; A"-losx_membership_stubs"];

    dep ["ocaml"; "link"; "native"; "library"; "use_osx_membership_stubs"]
      ["lib/libosx_membership_stubs"-.-(!Options.ext_lib)];
    flag ["ocaml"; "link"; "native"; "library"; "use_osx_membership_stubs"] &
    S[A"-cclib"; A"-losx_membership_stubs"];

    (* Linking generated lwt stubs *)
    dep ["ocaml"; "link"; "byte"; "library"; "use_osx_membership_lwt_stubs"]
      ["lwt/dllosx_membership_lwt_stubs"-.-(!Options.ext_dll)];
    flag ["ocaml"; "link"; "byte"; "library"; "use_osx_membership_lwt_stubs"] &
    S[A"-dllib"; A"-losx_membership_lwt_stubs"];

    dep ["ocaml"; "link"; "native"; "library"; "use_osx_membership_lwt_stubs"]
      ["lwt/libosx_membership_lwt_stubs"-.-(!Options.ext_lib)];
    flag ["ocaml"; "link"; "native"; "library";
          "use_osx_membership_lwt_stubs"] &
    S[A"-cclib"; A"-losx_membership_lwt_stubs"];
 
    (* Linking tests *)
    flag ["ocaml"; "link"; "byte"; "program"; "use_osx_membership_stubs"] &
      S[A"-dllib"; A"-losx_membership_stubs"];
    dep ["ocaml"; "link"; "byte"; "program"; "use_osx_membership_stubs"]
      ["lib/dllosx_membership_stubs"-.-(!Options.ext_dll)];

    flag ["ocaml"; "link"; "native"; "program"; "use_osx_membership_stubs"] &
      S[A"-cclib"; A"-losx_membership_stubs"];
    dep ["ocaml"; "link"; "native"; "program"; "use_osx_membership_stubs"]
      ["lib/libosx_membership_stubs"-.-(!Options.ext_lib)];

    (* Linking Lwt tests *)
    flag ["ocaml"; "link"; "byte"; "program"; "use_osx_membership_lwt_stubs"] &
      S[A"-dllib"; A"-losx_membership_lwt_stubs"];
    dep ["ocaml"; "link"; "byte"; "program"; "use_osx_membership_lwt_stubs"]
      ["lwt/dllosx_membership_lwt_stubs"-.-(!Options.ext_dll)];

    flag ["ocaml"; "link"; "native"; "program";
          "use_osx_membership_lwt_stubs"] &
    S[A"-cclib"; A"-losx_membership_lwt_stubs"];
    dep ["ocaml"; "link"; "native"; "program"; "use_osx_membership_lwt_stubs"]
      ["lwt/libosx_membership_lwt_stubs"-.-(!Options.ext_lib)];
